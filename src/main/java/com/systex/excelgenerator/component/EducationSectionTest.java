...
public class EducationSectionTest extends AbstractSection<Education> {

    private List<Education> educations;
    private CellStyle headerStyle;
    private CellStyle dataStyle;

    public EducationSection(XSSFWorkbook workbook, ProjectSection projectSection) {
        super("Education", workbook);
        headerStyle = cloneCellStyleWithFont(projectSection.getHeaderStyle());
        dataStyle = cloneCellStyleWithFont(projectSection.getDataStyle());
    }
